...
export default function GroupPanel({
  ...
  return (
    <details className="group border-2 border-[#1A1A1A] bg-white cursor-pointer hover:border-action transition-colors">
      <summary className="flex items-center justify-between p-6 bg-[#F5F2ED] select-none">
        <div className="flex items-center gap-4">
          ...
          <div>
             ...
             <h2 className="font-black text-xl uppercase tracking-tight text-action">ჯგუფების მართვა</h2>
          </div>
        </div>
                  ...
                  >
                    <summary className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-6 lg:p-8 cursor-pointer hover:bg-black/5 select-none transition-colors">
                      <div>
                        ...
                        <h3 className="font-black text-xl uppercase tracking-tighter group-open/item:text-action transition-colors">
                          {group.name.ka}
                        </h3>
